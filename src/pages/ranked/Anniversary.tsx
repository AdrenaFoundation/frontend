            ...
            <div className='w-full lg:w-1/2 lg:max-w-[30em] flex flex-row flex-wrap gap-2'>
              <div className='w-full flex flex-row flex-wrap p-4 border bg-main/40'>
                ...
                <div className="relative z-10 w-full flex flex-row flex-wrap items-center justify-center gap-2">
                  ...
                  <RaffleAdditionalPrize title="First Blood" reward={200} tippyText="First trader to open and close a position with a PnL/Volume ratio of 10% in the competition. PnL/Volume ratio formula: PnL / volume * 100" />
                  <RaffleAdditionalPrize title="Last Straw" reward={200} tippyText="Last trader to close a position with a PnL/Volume ratio of 10% before the competition ends. PnL/Volume ratio formula: PnL / volume * 100" />
                </div>
              </div>
