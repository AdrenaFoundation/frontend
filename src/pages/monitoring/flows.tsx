...
export default function Flow({
  ...
  return (
    <StyledContainer className="rounded-lg overflow-hidden p-5 flex flex-wrap">
      {(loading ? <div className="h-full w-full flex items-center justify-center text-sm min-h-[30rem]">
        <Loader />
      </div> :
