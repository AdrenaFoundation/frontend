            ...
            <div className='flex flex-col items-center justify-center relative '>
              ...
              <div className='flex w-full flex-col items-center justify-center'>
                ...
                <ul className="flex flex-row gap-3 md:gap-9 px-6 md:px-9 p-3 z-10 h-[6em] items-center w-full justify-center bg-third rounded-lg mt-4">
                  <li className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-center text-sm font-medium tracking-widest">Days</p>
                  </li>
                  ...
                  <li className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-center text-sm font-medium tracking-widest">Hours</p>
                  </li>
                  ...
                  <li className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-center text-sm font-medium tracking-widest">Minutes</p>
                  </li>
                  ...
                  <li className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-center text-sm font-medium tracking-widest">seconds</p>
                  </li>
                </ul>
              </div>
              ...
              <div className='flex flex-col items-center justify-center gap-2 mt-8 pb-8'>
                <div className='flex gap-2'>
                  <div className='text-sm font-medium text-txtfade'>{new Date(userVest.unlockStartTimestamp.toNumber() * 1000).toLocaleDateString()}</div>
                  <div className='text-sm font-medium text-txtfade'>-</div>
                  <div className='text-sm font-medium text-txtfade'>{new Date(userVest.unlockEndTimestamp.toNumber() * 1000).toLocaleDateString()}</div>
                </div>

                <div className='text-txtfade text-xs font-medium opacity-60'>vest period</div>
              </div>
              ...
              {isDelegate ?
                <>
                  ...
                  <div className='flex gap-4 pb-8 flex-col items-center justify-center'>
                    <div className='text-sm text-txtfade font-medium'>As delegate of this vest you can</div>
              ...
              {!isDelegate ? <>
                ...
                <div className="flex flex-col gap-2 w-full p-5 max-w-[40em] items-center justify-center self-center">
                  ...
                  <div className='min-h-[1.5em] flex items-center justify-center'>
                    {delegateError ? <div className='text-orange text-sm'>{delegateError}</div> : proofedUpdatedDelegate ? <div className='text-sm flex gap-1 font-medium text-txtfade'>
