      ...
      >
        ...
        <div className="flex w-full items-center justify-center gap-2 flex-col sm:flex-row sm:gap-10">
          <div className="flex flex-col gap-2 items-center">
            <div className="font-archivo text-white/80 tracking-widest uppercase text-xs">
              sort by
            </div>
        ...
        <div className="flex flex-row flex-wrap items-center justify-center sm:gap-4 pb-6">
          ...
          {filteredAchievements.length === 0 ? (
            <div className="font-archivo text-white/50 tracking-widest uppercase text-md pt-12 pb-12">
