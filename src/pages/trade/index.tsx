  ...
  return (
    <div className="w-full flex flex-col items-center lg:flex-row lg:justify-center lg:items-start z-10 min-h-full sm:p-4 pb-[200px] sm:pb-4">
      ...
      <div className="flex flex-col w-full">
        <div className="flex flex-col w-full border sm:rounded-lg overflow-hidden bg-main">
        ...
        {!!isBigScreen ? (
          <>
            <div className="bg-main mt-4 border rounded-lg relative">
              <ViewTabs
                view={view}
                setView={setView}
      ...
      <div className="relative w-full sm:hidden">
        <div className="fixed left-0 bottom-[2.8125rem] w-full bg-bcolor backdrop-blur-sm p-3 z-30">
          <ul className="flex flex-row gap-3 justify-between ml-4 mr-4">
            <li>
              <Button
                className="bg-transparent font-medium border-[#10e1a3] text-[#10e1a3]"
                title="Long"
                variant="outline"
                size="lg"
                onClick={() => {
            ...
            <li>
              <Button
                className="bg-transparent font-medium border-[#f24f4f] text-[#f24f4f]"
                title="Short"
                variant="outline"
                size="lg"
                onClick={() => {
            ...
            <li>
              <Button
                className="bg-transparent font-medium border-white text-white"
                title="Swap"
                variant="outline"
                size="lg"
                onClick={() => {
