...
import { getPythProgramKeyForCluster, PriceStatus, PythConnection } from "@pythnetwork/client";
...
const useListenToPythTokenPricesChange = (): PythConnection | null => {
    ...
    useEffect(() => {
        ...
        setPythConnection(new PythConnection(connection, getPythProgramKeyForCluster('devnet'), 'confirmed', Object.values(feedIds)));
    }, [connection]);
