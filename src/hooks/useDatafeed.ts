...
} from '@/components/pages/trading/TradingChart/streaming';
import { SUPPORTED_RESOLUTIONS } from '@/constant';
import { generateSymbol, makeApiRequest, parseFullSymbol } from '@/utils';
...
const useDatafeed = () => {
  ...
  const datafeed = {
    ...
    resolveSymbol: async (
      ...
      onSymbolResolvedCallback(symbolInfo as any);
    },
