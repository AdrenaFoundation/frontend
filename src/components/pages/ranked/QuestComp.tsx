...
export default function QuestComp({
  ...
  return (
    ...
    >
      ...
      {quest.description ? (
        <p className="font-semibold opacity-50 mb-3">{quest.description}</p>
      ) : null}
          ...
          if (task.type === 'text') {
            return (
              ...
              >
                ...
                {task.description ? (
                  <p className="font-semibold opacity-50 mb-3">
                    {task.description}
                  </p>
                ) : null}{' '}
                <div className="flex flex-row gap-6 justify-between items-center">
                  <div className="flex flex-row gap-2">
                    <input
                      ...
                      onChange={() => false}
                    />
                    <p className="font-semibold opacity-50">{task.task}</p>
                  </div>
            ...
            >
              <div className="flex flex-row gap-2 items-center">
                ...
                <div>
                  ...
                  <p
                    className={twMerge(
                      'opacity-50 font-semibold max-w-[350px]',
