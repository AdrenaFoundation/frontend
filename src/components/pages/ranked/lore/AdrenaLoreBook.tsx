  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col sm:flex-row border pl-4 pr-4 pt-2 pb-2 gap-6 items-center bg-black/30 relative">
        <h2
          className="text-md font-['system-ui']"
          style={{
            ...
            <div key={label} className="flex items-center">
              <div
                ...
                className={twMerge(
                  ...
                  // TODO: Change when having more than one chapter
                  index > 0
                    ? 'cursor-not-allowed hover:opacity-100 line-through'
                    : 'cursor-pointer',
                )}
              >
                {label}
        ...
        <div
          className={`rounded-full border absolute top-2 right-2 sm:relative sm:top-0 sm:right-auto sm:ml-auto cursor-pointer text-sm pt-1 pb-1 pr-2 pl-2 ${
            mode === 'dark'
      ...
      <div
        className={twMerge(
          ...
          mode === 'light'
            ? 'bg-white/90 chapter-wrapper-light'
            : 'bg-black/30 chapter-wrapper-dark',
        )}
      >
