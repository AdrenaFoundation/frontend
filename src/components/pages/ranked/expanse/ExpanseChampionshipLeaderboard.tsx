      ...
      const values = [
        ...
        >
          ...
          <div id={`user-season-${d.wallet.toBase58()}`}>
            ...
            {filler ? (
              <div className="w-20 h-2 bg-gray-800 rounded-md" />
            ) : null}
            ...
            {filler ? (
              <div className="w-20 mt-1 h-2 bg-gray-800 rounded-md" />
            ) : null}
          </div>
        </div>,
      ];
          ...
          >
            {!filler ? (
              <>
                <FormatNumber
                  nb={d.volume}
                  className="text-xs font-semibold text-[#fa6723]"
                  precision={2}
          ...
          {!filler ? (
            <div>
              <FormatNumber
                ...
                className="text-xs font-semibold text-[#fa6723]"
                precision={
                  d.championshipPoints && d.championshipPoints >= 50 ? 0 : 2
                }
                suffixClassName="text-xs font-semibold text-[#fa6723]"
                suffix="Points"
                isDecimalDimmed={false}
              />
              {d.rewardsAdx && d.rewardsJto && isMobile ? (
                <div className="flex">
                  <FormatNumber
                    ...
                    prefix="+"
                    nb={
                      d.rewardsAdx * (tokenPrices['ADX'] ?? 0) +
                      d.rewardsJto * (tokenPrices['JTO'] ?? 0)
                    }
            ...
            content={
              <div className="text-xs font-semibold min-w-[15em]">
                <div className="flex gap-1 p-2 bg-third rounded items-center justify-center">
                  ...
                  <span className="flex font-semibold text-sm">ADX</span>
                </div>
                ...
                <div className="flex gap-1 p-2 bg-third rounded items-center justify-center mt-2">
                  ...
                  <span className="flex font-semibold text-sm">JTO</span>
                </div>
              </div>
            }
          >
