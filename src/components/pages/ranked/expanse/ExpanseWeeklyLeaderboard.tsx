                    ...
                    <div id={`user-weekly-${d.wallet.toBase58()}`}>
                        ...
                        {!filler && !d.nickname ? (
                            <p
                                key={`trader-${i}`}
                                className={twMerge(
                                    'text-xs text-txtfade font-medium hover:underline transition duration-300 cursor-pointer',
                                )}
                                onClick={() => {
                                    onClickUserProfile(d.wallet);
                                }}
                    ...
                    {d.championshipPoints ? (
                        <div className="flex">
                            <FormatNumber
                                ...
                                className="text-[#fa6723] text-xs font-medium"
                                prefix="+"
                                suffixClassName="text-[#fa6723]"
                                isDecimalDimmed={false}
                            />

                            <span className="flex text-[#fa6723] font-medium text-xs ml-1">
                                Points
                            </span>
                        </div>
                    ) : null}
