  ...
  return (
    <>
      <div className="w-full mx-auto relative flex flex-col items-center gap-6">
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row w-full items-center justify-center relative">
            <Select
              ...
              selectedTextClassName="font-medium text-lg tracking-[0.2rem] uppercase"
            ...
            <div className="font-medium text-lg tracking-[0.2rem] uppercase text-center sm:text-left">
        ...
        <div className="font-medium text-sm tracking-[0.2rem] uppercase">
          DAMAGE METER
        </div>
