...
export const NB_HEALTH_BAR = 20;
export const TOTAL_BONK_REWARDS = 4_000_000_000;
export const TOTAL_JTO_REWARDS = 25_000;
export const TOTAL_ADX_REWARDS = 2_000_000;
export const TOTAL_ADX_DEFEATED_BOSS = 200_000;
