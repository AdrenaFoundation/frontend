...
export const PICTURES = {
  'A-General':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/A-general-XslAAKuuLulnWZjojoSgUfpcvPSUao.jpg',
  'A-Lieutenant':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/A-lieutenant-rlj75BR7yTwcCLDqghVw8pGQuqDdGp.jpg',
  'A-Sergeant':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/A-sergeant-TOF5salEAeiwnZNQTqmcRLk0078M54.jpg',
  'B-General':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/B-general-3qXDpxizWvG7cbhgPS0aYkiXzWHpO3.jpg',
  'B-Lieutenant':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/B-lieutenant-o07VbHByp3D6dQIpzhvzPyEeT6W0qy.jpg',
  'B-Sergeant':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/B-sergeant-Kd64lsAO14Y6UAEQAkwj0EpIWrj8Mc.jpg',
} as const;

export const VIDEOS = {
  'A-General':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/A-general-min-b2GPGwqAkYTg2fgbHk9NoJQctXAoC7.mp4',
  'A-Lieutenant':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/A-lieutenant-min-D41q6tc0ICwkZAQ4ta2VM63a9ut1iH.mp4',
  'A-Sergeant':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/A-sergeant-min-8reQ7QR91eU12wDsmT60jemzdQzi41.mp4',
  'B-General':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/B-general-min-ranNOjktaYLWmRq8LHDV2zIIKjcpa9.mp4',
  'B-Lieutenant':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/B-lieutenant-min-YztfpfQH9UKkPyUTS1PY3khxhE5EoY.mp4',
  'B-Sergeant':
    'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/factions/B-sergeant-min-4JzRx87YHLqqrVBR3aUjI1WZNjwwKU.mp4',
} as const;
...
export default function Rank({
  ...
  const expectedBonusPillage =
    rank === 'Sergeant' ? 2.5 : rank === 'Lieutenant' ? 5 : 10;

  return (
    <div className="flex flex-col gap-2 relative">
      <div
        className={twMerge('relative flex flex-col gap-2')}
        onMouseEnter={() => {
          setDisplayVideo(true);
          setHover(true);
        }}
      ...
      >
        ...
        <div
          className={twMerge(
            ...
            user.steps === 3
              ? team === 'A'
                ? 'border-[#FA6724] shadow-[0_0_12px_#FA6724] animate-pulse opacity-100'
                : 'border-[#5AA6FA] shadow-[0_0_12px_#5AA6FA] animate-pulse opacity-100'
              : '',
          )}
        >
          <div className="w-full h-full">
            {displayVideo ? (
              <video
                ...
                playsInline
                className={twMerge(
                  'w-full h-full object-cover z-10 absolute',
                  className,
                )}
        ...
        >
          {user && user.wallet.toBase58() !== PublicKey.default.toBase58() ? (
            <>
              ...
              >
                {user.nickname && user.nickname.length
                  ? user.nickname
                  : getAbbrevWalletAddress(user.wallet.toBase58())}
              </div>
            </>
          ) : (
            <div className={twMerge('font-archivo tracking-widest text-xs')}>
              Not assigned
            </div>
          )}
        </div>
          ...
          >
            <div
              className={twMerge(
                ...
                user.steps >= 1
                  ? team === 'A'
                    ? 'bg-[#FA6724] shadow-[0_0_8px_#FA6724]'
                    : 'bg-[#5AA6FA] shadow-[0_0_8px_#5AA6FA]'
                  : 'bg-bcolor text-txtfade',
              )}
            >
              1
            </div>
      ...
      <div className="flex flex-col">
        <div
          className={twMerge(
            ...
            unlockStep === 3
              ? 'text-[#FA6724FA] font-archivo tracking-widest'
              : '',
          )}
        >
