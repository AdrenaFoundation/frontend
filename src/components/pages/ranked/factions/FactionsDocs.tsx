    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3 border border-[#333] rounded-md p-5 hover:border-[#444] transition-colors">
        <div className="flex items-center gap-2">
          <Image src={mutagenIcon} alt="logo" width={24} height={24} />
          <div className="font-archivoblack text-lg text-white">
            Earn Mutagens
          </div>
        </div>
          ...
          <div className="border border-[#333] rounded-md p-6">
              ...
              <ul className="leading-relaxed pl-4 list-disc mb-4">
                ...
                <li>
                  ...
                  <Tippy content={minMutagenTooltip}>
                    <span className="text-gold underline-dashed">
            ...
            <div>
              ...
              <ul className="leading-relaxed pl-4 list-disc mb-4">
                ...
                <li>
                  Mutagen: <span className="text-[#e47dbb] font-bold">+0</span>{' '}
                  to <span className="text-[#e47dbb] font-bold">+0.05</span>
                </li>
              </ul>
            </div>
            <div className="my-4 border-t border-[#333]" />
        ...
        <div className="flex flex-col gap-3 border border-[#333] rounded-md p-5 hover:border-[#444] transition-colors">
          ...
          <div className="flex flex-col text-base gap-2">
            ...
            <div className="text-[#bbb] leading-relaxed">
              ...
              you destroy releases weekly ADX/JTO/BONK rewards and seasonal ADX
              bonuses. Defeat the boss every week to claim the full prize pool!
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 border border-[#333] rounded-md p-5 hover:border-[#444] transition-colors">
          ...
          <div className="flex flex-col text-base gap-2">
            ...
            <div className="text-[#bbb] leading-relaxed">
              ...
              maximize their team&apos;s pillage potential and activate powerful
              mutagen self-referrals.
            </div>
            ...
            <div className="text-[#bbb] leading-relaxed pl-4">
              ...
              <span className="text-blue-300 font-medium">2×</span> their
              General&apos;s mutagen seize command.
            </div>
            <div className="text-[#bbb] leading-relaxed pl-4">
              → Sergeants who produce{' '}
              <span className="text-blue-300 font-medium">3×</span> their
              Lieutenant&apos;s mutagen earn promotion.
            </div>
            <div className="text-[#bbb] leading-relaxed pl-4">
              → Any faction member generating{' '}
              <span className="text-blue-300 font-medium">4×</span> their
        ...
        <div className="flex flex-col gap-3 border border-[#333] rounded-md p-5 hover:border-[#444] transition-colors">
          ...
          <div className="flex flex-col text-base gap-2">
            <div className="text-[#bbb] leading-relaxed">
              ...
              <span className="text-white font-medium">30%</span> of enemy
            ...
            <div className="p-3 rounded-md mt-1 border border-[#222]">
              <div className="text-white font-medium mb-1">
                Example 1: Total Victory
              </div>
              <div className="text-[#bbb] leading-relaxed">
                Team <span className="text-[#5AA6FA] font-medium">JITO</span>:{' '}
                <span className="text-[#e47dbb]">200</span> mutagen damage |
                Team <span className="text-[#FA6724] font-medium">BONK</span>:{' '}
                <span className="text-[#e47dbb]">150</span> mutagen damage
              </div>
              <div className="text-[#bbb] leading-relaxed pl-4">
                → <span className="text-[#5AA6FA] font-medium">JITO</span>
                &apos;s <span className="text-white font-medium">33%</span>{' '}
                damage advantage + completed officer goals giving a max cap of{' '}
                <span className="text-white font-medium">30%.</span>
              </div>
              <div className="text-[#bbb] leading-relaxed pl-4">
                → Result:{' '}
                <span className="text-[#5AA6FA] font-medium">JITO</span> seizes
                the maximum <span className="text-white font-medium">30%</span>{' '}
                of <span className="text-[#FA6724] font-medium">BONK</span>
                &apos;s weekly rewards, adding them to their own treasure hoard.
              </div>
            </div>
            ...
            <div className="p-3 rounded-md mt-1 border border-[#222]">
              ...
              <div className="text-[#bbb] leading-relaxed pl-4">
                → <span className="text-[#FA6724] font-medium">BONK</span>
                &apos;s <span className="text-white font-medium">33%</span>{' '}
              ...
              <div className="text-[#bbb] leading-relaxed pl-4">
                ...
                <span className="text-[#FA6724] font-medium">BONK</span>{' '}
                pillages just{' '}
                <span className="text-white font-medium">15%</span> of{' '}
                <span className="text-[#5AA6FA] font-medium">JITO</span>&apos;s
                rewards—officer performance halved their raiding potential.
              </div>
            </div>
            ...
            <div className="p-3 rounded-md mt-1 border border-[#222]">
              ...
              <div className="text-[#bbb] leading-relaxed pl-4">
                → <span className="text-[#5AA6FA] font-medium">JITO</span>
                &apos;s modest{' '}
                <span className="text-white font-medium">15%</span> damage
                advantage + fully completed officer goals, giving a max cap of{' '}
                <span className="text-white font-medium">30%.</span>
              </div>
              <div className="text-[#bbb] leading-relaxed pl-4">
                → Result:{' '}
                <span className="text-[#5AA6FA] font-medium">JITO</span> claims{' '}
                <span className="text-white font-medium">15%</span> of{' '}
                <span className="text-[#FA6724] font-medium">BONK</span>&apos;s
                rewards—pillage percentage matches their damage differential.
              </div>
            </div>
          </div>
        </div>
