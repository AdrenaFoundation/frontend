                ...
                {startDate && startDate.getTime() >= Date.now() ? (
                    <ul className="flex flex-row gap-3 md:gap-9 mt-2 px-6 md:px-9 p-3 bg-black/40 rounded-lg z-10">
                        <li className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-center text-sm font-medium tracking-widest">
                                Days
                            </p>
                        </li>
                            ...
                            {adxRewards > 0 ?
                                <div className="flex flex-row gap-1 items-center justify-center">
                                    ...
                                    <FormatNumber
                                        ...
                                        className="text-md font-medium text-txtfade"
                                        suffixClassName='text-base font-medium text-txtfade'
                                        isDecimalDimmed={false}
                                    />
                        ...
                        startDate <= new Date() ? (
                            <>
                                <RemainingTimeToDate
                                    ...
                                    tippyText=""
                                />
                                <span className="ml-2 text-base font-medium tracking-widest">
                                    left
                                </span>
                            </>
                        ) : (
