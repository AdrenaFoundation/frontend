    ...
    <div className={twMerge("flex-wrap flex-row w-full flex gap-6 pl-4 pr-4", className)}>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 w-full">
        <NumberDisplay
          ...
          format="currency"
          precision={2}
          className='border-0 bg-third pl-4 pr-4 pt-5 pb-5'
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 w-full">
        <NumberDisplay
          ...
          headerClassName='pb-2'
          titleClassName='text-[0.7em] sm:text-[0.7em]'
          bodyClassName='text-green text-base'
        />
        ...
        <div className='flex-col w-full rounded-lg z-20 relative flex items-center flex-1 min-h-[2em] border-0 bg-third pl-4 pr-4 pt-5 pb-5'>
          <div className='flex flex-col text-center justify-center pb-2 uppercase text-txtfade text-[0.7em] sm:text-[0.7em] font-boldy'>
            Positions
          </div>
        ...
        <div className="flex-col w-full rounded-lg p-3 z-20 relative flex items-center flex-1 min-h-[2em] border-0 bg-third pl-4 pr-4 pt-5 pb-5">
          <div className="flex flex-col text-center justify-center pb-2">
            <div className="flex flex-col">
              <h1 className="text-txtfade font-boldy text-[0.7em] sm:text-[0.7em]">Avg. Time Opened</h1>
              <h5 className="opacity-50 text-xs text-txtfade"></h5>
            </div>
          </div>
          <div className="flex flex-col gap-0">
            <p className="font-mono inline-block text-base">{formatSecondsToTimeDifference(traderInfo?.avgHoldingTime ?? 0)}</p>
          </div>
        </div>
      </div>
    </div>
