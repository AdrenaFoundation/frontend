...
export default function MigrateUserProfileV1Tov2Modal({
    ...
    return (
        ...
        >
            <div className="font-medium text-white/80 pl-4 pr-4 sm:max-w-[30em] self-center text-center pt-6 pb-6 relative">
            ...
            <div className='h-[2em]'>
                {(trimmedUpdatedNickname && trimmedUpdatedNickname.length < 3) || !trimmedUpdatedNickname ?
                    <div className="text-red-500 text-xs text-center mb-4 text-txtfade font-medium">Must be at least 3 characters long</div> :
                    null}
                ...
                {trimmedUpdatedNickname && alreadyTakenNicknames[trimmedUpdatedNickname] === true ?
                    <div className="text-red-500 text-xs text-center mb-4 text-yellow-400 font-medium">Nickname already taken</div> :
                    null}

                {trimmedUpdatedNickname && alreadyTakenNicknames[trimmedUpdatedNickname] === false ?
                    <div className="text-red-500 text-xs text-center mb-4 text-green font-medium">Nickname available</div> :
                    null}
            </div>
            ...
            <span className='text-xs ml-auto mr-auto cursor-pointer text-txtfade hover:text-white mt-2'
                onClick={() => {
            ...
            <div className="p-3 w-full flex flex-col items-center">
                {isFaqVisible ? <div className='flex flex-col sm:max-w-[30em] text-center gap-4 pb-4'>
                    <div className='flex flex-col gap-1'>
                        <div className="text-sm font-medium">Why do I need to migrate?</div>
                    ...
                    <div className='flex flex-col gap-1'>
                        <div className="text-sm font-medium">What if I don&apos;t migrate?</div>

                        <div className="text-sm text-txtfade">
                            Most on-chain actions require Profile V2.
                            Without migrating, you won&apos;t be able to interact with the smart contract.
                        </div>
                    </div>

                    <div className='flex flex-col gap-1'>
                        <div className="text-sm font-medium">What does migration cost?</div>
