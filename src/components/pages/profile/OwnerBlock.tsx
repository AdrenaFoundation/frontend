              ...
              {profilePictureHovering && !readonly ? (
                <>
                  ...
                  <div className="h-full w-full absolute z-20 items-center justify-center flex flex-col">
                    <div className="font-black tracking-widest opacity-70 text-sm text-center">
        ...
        {nicknameUpdating ? (
          ...
          >
            <div className="flex flex-col gap-3">
              ...
              <InputString
                className="font-medium text-xl relative p-3 border rounded-lg text-center"
              ...
              <div className="h-[1em]">
                {(trimmedUpdatedNickname &&
                  trimmedUpdatedNickname.length < 3) ||
                  !trimmedUpdatedNickname ? (
                  <div className="text-red-500 text-xs text-center mb-4 text-txtfade font-medium">
                ...
                {trimmedUpdatedNickname &&
                  ...
                  <div className="text-red-500 text-xs text-center mb-4 text-yellow-400 font-medium">
                ...
                {trimmedUpdatedNickname &&
                  ...
                  <div className="text-red-500 text-xs text-center mb-4 text-green font-medium">
