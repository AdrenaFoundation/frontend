...
export default function Achievement({
  ...
  const category = useMemo(
    () =>
      ({
        bronze:
          'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/achievements-categories/cat-bronze-WP9sNaPqTgig10wg5FBDUvLtIjDI1x.png',
        silver:
          'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/achievements-categories/cat-silver-CwUvDehdfegumOBkVF3FtLWU7M2iM2.png',
        ...
        platinum:
          'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/achievements-categories/cat-platinum-Xge9np4xUOYNAgcVtlOu97lYqv9c5N.png',
        diamond:
          'https://iyd8atls7janm7g4.public.blob.vercel-storage.com/achievements-categories/cat-diamond-qXRUCzTau4zTeQYJoamX9DclelnNyw.png',
      })[achievement.category],
    [achievement.category],
  );

  const stat = achievement.nbUserProfiles ? (
  ...
  return (
    <div className={twMerge('flex flex-col gap-2 items-center', className)}>
      ...
      >
        <div
          className={twMerge(
            'h-[21.44em] w-[16em] relative',
            unlocked ? '' : 'opacity-50',
          )}
        >
          {/* Title */}
          <h3 className="absolute z-10 font-bold w-full top-[2.6em] left-[3em] text-black/80 text-[0.55em]">
            {achievement.title}
          </h3>
          ...
          <div className="absolute top-[12.25em] left-[1.5em] z-10 flex items-center justify-center gap-1">
            <Tippy
              content={
                <div className="text-xs">
                  Achievement {achievement.index + 1}/{ACHIEVEMENTS.length}
                </div>
              }
              className="z-20"
            >
            ...
            {typeof achievement.titleUnlock !== 'undefined' ? (
              <Tippy
                content={
                  <div className="text-xs">
                    Unlocks title &ldquo;
                    {USER_PROFILE_TITLES[achievement.titleUnlock]}&ldquo;
                  </div>
                }
                className="z-20"
              >
                <div className="text-xxs font-mono text-white rounded-full bg-black w-[1.2em] h-[1.2em] flex items-center justify-center relative bottom-[0.1em]">
                  T
                </div>
              </Tippy>
            ) : null}
            ...
            {typeof achievement.wallpaperUnlock !== 'undefined' ? (
              <Tippy
                content={
                  <div className="flex flex-col items-center justify-center gap-2">
                    <div className="text-xs">Unlocks a unique wallpaper</div>
          ...
          <Tippy
            content={
              <div className="text-xs">{achievement.category} category</div>
            }
            className="z-20"
          >
          ...
          {/* Achievement points */}
          <Tippy
            content={<div className="text-xs">Achievement points</div>}
            className="z-20"
          >
            <div
            ...
            >
              <div className="text-sm text-black/90 font-regular">
                {achievement.points}
              </div>
            </div>
          </Tippy>
          ...
          {/* Description */}
          <div className="absolute z-10 top-[13.3em] left-[1em] w-[14em] h-[6.8em] flex flex-col pl-4 pr-4 pt-2 pb-3">
            <div className="text-[0.65em] text-black/90 font-regular">
