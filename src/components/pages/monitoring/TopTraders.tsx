    ...
    <>
      <div className="bg-[#040D14] border rounded-lg p-3">
        <div className="flex gap-2">
          <p className="font-medium text-lg">Top {numberTraders} traders</p>
          <p className="font-medium text-txtfade text-lg">(closed trades)</p>
        </div>
        <div className="px-4">
          <div className="mt-3">
            <Table
              ...
              data={sortedTraders.map((trader, i) => ({
                ...
                values: [
                  ...
                  <div
                    className="flex items-center justify-end lg:justify-center grow"
                    key={`average_trade_time-${i}`}
                  >
                    <FormatNumber
                  ...
                  <div
                    className="flex items-center justify-end lg:justify-center grow"
                    key={`volume_weighted_pnl_percentage-${i}`}
                  >
                    <FormatNumber
