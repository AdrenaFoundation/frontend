      ...
      >
        ...
        >
            ...
            {lockedStakes.length > 1 ? (
              <div className="text-sm flex gap-1 ">
                ...
                <div className="flex">
                  ...
                  <div className="text-txtfade font-boldy">
                    {lockedStakes.length}
                  </div>
                  <div className="sm:hidden text-txtfade">{')'}</div>
                </div>
                <div className="hidden sm:block text-txtfade font-boldy">
                  stakes
                </div>
              </div>
            ) : null}
          ...
          {firstUnlock !== null ? (
            <div className="flex items-center justify-center ml-auto flex-col sm:flex-row sm:gap-2">
              <div className="text-xs font-boldy text-txtfade">
        ...
        <div className="flex flex-col pt-2 pb-2 items-center relative w-full">
          ...
          {lockedStakes.length === 1 && lockedStakes[0].isGenesis ? (
            <div className="text-xxs bg-[#068862a0] font-boldy pt-[0.1em] pb-[0.1em] px-2 mt-1 rounded w-14 text-center">
              genesis
            </div>
          ) : null}
          ...
          <div className="flex border-t pt-2 pb-2 w-full justify-evenly flex-wrap gap-y-4 gap-x-4">
            <div className="flex items-center gap-2">
              ...
              >
                <div className="flex items-center flex-col">
                  <div className="text-xs text-txtfade font-boldy underline decoration-dotted">
                    USDC Reward Weight
                  </div>
            ...
            {totalWeight.votingPower ? (
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center flex-col">
                  <div className="text-xs text-txtfade font-boldy">
                    Voting Power
                  </div>
                  <div className="flex items-center justify-center gap-1">
                    <FormatNumber
        ...
        <div className="w-full items-center justify-center flex flex-col border-t  cursor-pointer">
          ...
          >
            <div className="flex gap-1 opacity-40 hover:opacity-100 cursor-pointer transition-opacity justify-center items-center">
              ...
              {lockedStakes.length > 1 ? (
                <div className="text-xs flex gap-1 font-boldy text-txtfade">
                  ({lockedStakes.length})
                </div>
              ) : null}
            </div>
            ...
            <Image
              ...
              height={20}
              alt="Chevron icon"
              className={twMerge('opacity-20', detailOpen ? 'rotate-180' : '')}
            />
          </div>
