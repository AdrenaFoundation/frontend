...
export default function LockedStake({
  ...
  return (
    ...
    >
      ...
      >
        <div className="font-boldy text-xs border w-full sm:rounded-xl sm:w-16 h-6 items-center justify-center bg-[#1e272e] flex text-txtfade">
        ...
        <div className="ml-0 flex gap-0 items-center">
          ...
          {lockedStake.isGenesis ? (
            <div className="text-xxs bg-[#068862a0] font-boldy pt-[0.1em] pb-[0.1em] px-2 ml-4 rounded w-14 text-center">
              genesis
            </div>
          ) : null}
        </div>
