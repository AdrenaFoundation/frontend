    ...
    <div className="w-full flex flex-col border rounded-md bg-secondary overflow-hidden mb-2">
      <div className="grid grid-cols-2 sm:flex sm:flex-row gap-5 justify-between sm:items-center p-3 sm:p-2 mx-2">
        ...
        <div className="flex flex-1 flex-col sm:text-center">
          ...
          <p
            className={`text-xs font-mono opacity-50 ${
              claim.source === 'manual' ? 'text-orange' : 'text-blue'
            }`}
          >
            {claim.source}
          </p>
        ...
        <div className="flex-1 sm:text-center">
          <div className="block sm:hidden w-full font-mono text-xxs text-txtfade">
            USDC reward
          </div>
          <FormatNumber
        ...
        <div className="flex-1 flex flex-col sm:items-end">
          <div className="block sm:hidden w-full font-mono text-xxs text-txtfade text-left">
            ADX reward
          </div>

          <div
            className={`w-full flex sm:justify-end text-gray-400 text-xs ${claim.rewards_adx_genesis > 0 ? 'underline-dashed' : ''}`}
          >
            <FormatNumber
