...
export default function FullyLiquidALPStaking({
    ...
    const { stakingAccount } = useStakingAccount(window.adrena.client.lpTokenMint);
        ...
        <div className="flex flex-col bg-main rounded-2xl border">
            <div className="p-5 pb-0">
                <div className="flex flex-col h-full w-full bg-gradient-to-br from-[#07111A] to-[#0B1722] border rounded-lg shadow-lg">
                    <p className="opacity-75 text-base p-3 flex flex-col gap-2">
                        ...
                        <span className='cursor-pointer text-txtfade underline text-base'>Learn More</span>
                    </p>

                    <div
                        className={twMerge(
                            'flex items-center w-full rounded-bl-lg rounded-br-lg p-3 flex-none border-t bg-[#130AAA]',
                        )}
                    >
                                ...
                                <div className="flex justify-between">
                                    <span className="text-txtfade">
                                        ...
                                        <span className="text-txtfade ">
                                            (see
                                            <Link
                                                href='https://docs.adrena.xyz/tokenomics/alp/staked-alp-rewards-emissions-schedule'
