...
export default function FullyLiquidALPStaking({
  ...
  const allTimeClaimedUsdc = alpClaimHistory?.allTimeRewardsUsdc ?? 0;
  const allTimeClaimedAdx =
    (alpClaimHistory?.allTimeRewardsAdx ?? 0) +
    (alpClaimHistory?.allTimeRewardsAdxGenesis ?? 0);
  ...
  const calculateMedianStakedTime = sortedLockedStakes.reduce(
    (median, lockedStake) => {
  ...
  const medianStakedTime = calculateMedianStakedTime.total
    ? calculateMedianStakedTime.acc / calculateMedianStakedTime.total
    : 0;
    ...
    <div className="flex flex-col bg-main rounded-md border">
      <div className="p-5 pb-0">
        <div className="flex flex-col h-full w-full bg-gradient-to-br from-[#07111A] to-[#0B1722] border rounded-md shadow-lg">
          <span className="text-lg font-semibold ml-auto mr-auto mt-2">
            Attention: ALP is becoming fully liquid
          </span>
          ...
          <p className="opacity-75 text-base p-3 flex flex-col gap-2 text-center">
            <span className="text-base">
              Starting 19th march 2025, 12:00 UTC, ALP becomes fully liquid and
              ALP staking system is discontinued.
            </span>

            <span className="text-base">
              All existing stakes to be unlocked for free (no more liquidity
              mining nor USDC yield redistributed).
            </span>

            <span className="text-base">
              Fully liquid ALP will enable DeFi integrations like looping and
              other strategies while boosting native yield through
              autocompounding.
            </span>
          </p>
          ...
          >
            <span className="text-sm border-dashed border-b w-auto text-white border-white opacity-40 hover:opacity-100">
      ...
      <div className="w-full items-center justify-center flex mt-6">
        <Button
          ...
          size="sm"
          title={
            isClaimingRewardsAndRedeeming
              ? 'Claiming and redeeming...'
              : 'Claim rewards and redeem'
          }
          className="px-5 w-[90%]"
          onClick={handleClaim}
        />
            ...
            <div className="flex flex-col space-y-1 flex-grow">
              <div className="flex justify-between">
                <span className="text-txtfade">
                  Your share of 70% platform&apos;s revenue:
                </span>
              ...
              <div className="flex justify-between">
                <span className="text-txtfade">LM rewards</span>
                <div className="flex items-center">
                ...
                <div className="flex justify-between">
                  <span className="text-txtfade">
                    ...
                    <Tippy
                      content={
                        <p>
                          These rewards accrue over time for the first 180 days
                          of the protocol. The amount is proportional to your
                          participation in the Genesis Liquidity campaign.{' '}
                          <br />
      ...
      <div className="mt-4">
        ...
        <Tippy trigger="mouseenter" content="Median staked time.">
      ...
      <div
        className="text-xs ml-auto mr-auto cursor-pointer text-txtfade hover:text-white mt-2 mb-6"
