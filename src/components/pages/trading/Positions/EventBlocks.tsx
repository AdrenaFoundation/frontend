              ...
              {events.length > 0 ? (
                ...
                >
                  {events.map((event, index) => (
                    <div
                      className="relative border border-inputcolor rounded-xl w-fit"
                      key={index}
                    >
                      <svg
                        width={16}
                        ...
                        className="absolute -left-6 w-3 h-3 rounded-full top-1/2 -translate-y-1/2 z-10"
                      >
                        <circle
                          cx="6"
                          cy="6"
                      ...
                      {index < events.length - 1 && (
                        <div className="absolute -left-[1.2rem] w-[0.0625rem] bg-inputcolor top-1/2 translate-y-1 h-[calc(100%+0.75rem)]" />
                      )}
    ...
    <div className="flex flex-row flex-wrap">
      {displayData.map((item, index) => (
        <div
          key={index}
          className={twMerge(
            'flex flex-col border-r border-r-inputcolor last:border-r-0 px-6 first:pl-0 transition-opacity duration-300 cursor-pointer',
            hoveredEvent !== null &&
