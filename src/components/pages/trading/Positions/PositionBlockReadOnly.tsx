...
// FIXME: Factorize with PositionBlock
export default function PositionBlockReadOnly({
  ...
  const positionName = (
    <div className="flex items-center justify-left h-full min-w-[12em]">
      <Image
    ...
    <div className="flex flex-col items-center min-w-[10em] w-[10em]">
      ...
      {position.pnl ? (
        <div className="flex items-center">
          <FormatNumber
            nb={showAfterFees ? position.pnl + fees : position.pnl}
            format="currency"
      ...
      >
        ...
        {liquidable && (
          <div className="flex items-center justify-center pt-2 pb-2 border-t gap-4">
            {liquidable && <h2 className="text-red text-xs">Liquidable</h2>}
          </div>
        )}
      </div>
    </>
