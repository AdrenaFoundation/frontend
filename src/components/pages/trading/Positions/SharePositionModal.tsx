    ...
    <div className="max-w-[600px] p-5">
      ...
      >
        ...
        <FormatNumber
          ...
          className={twMerge(
            'text-[60px] sm:text-[70px] font-black relative z-10',
        ...
        <ul className="flex flex-row gap-6 mt-[10px] sm:mt-7 relative z-10">
          ...
          <li className="flex flex-col gap-1">
            ...
            <span className="font-black text-sm sm:text-lg">{openedOn}</span>
          </li>
        </ul>
      ...
      <div className="flex flex-col gap-3 mt-3">
        ...
        >
          <p className="font-medium text-base">Display PnL in USD</p>
        ...
        >
          <p className="font-medium text-base">Display PnL with fees</p>
          <label className="flex items-center ml-1 cursor-pointer">
            <Switch
              className="mr-0.5"
              checked={isPnlWFees}
