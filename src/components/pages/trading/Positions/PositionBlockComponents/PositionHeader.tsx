      ...
      <div className="flex flex-col w-full items-center">
        ...
        {!isHistory ? (
          <div className="border-b flex-1 flex w-full p-2">
            <div className="flex flex-col">{pnl}</div>
            <div className="flex flex-col ml-auto">{netValue}</div>
          </div>
        ) : (
  ...
  if (isHistory) {
    return (
      <div className={headerClasses}>
        ...
        <div className="ml-auto 2xl:absolute 2xl:left-1/2 2xl:-translate-x-1/2">
          {pnl}
        </div>
