...
export const PositionName = ({ position, readOnly, isHistory, setTokenB }: PositionNameProps) => {
            ...
            <div className="flex flex-col justify-start items-start gap-0.5 inline-flex">
                <div className="flex items-center justify-center gap-2">
                    ...
                    <div className="text-center text-whiteLabel text-sm font-extrabold font-mono">
                        <FormatNumber
                            nb={'initialLeverage' in position ? position.initialLeverage : position.entryLeverage}
                            format="number"
                            precision={0}
