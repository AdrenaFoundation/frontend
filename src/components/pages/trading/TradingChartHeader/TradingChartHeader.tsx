...
export default function TradingInputs({
  ...
  const infoStyle =
    'flex flex-col sm:flex-row gap-1 xl:gap-2 bg-secondary p-1 px-5 rounded-full';

  return (
    <div
      className={twMerge(
        'flex items-center gap-2 h-14 bg-gray-200 border border-gray-300 border-b-transparent rounded-t-lg',
        className,
      )}
    >
