...
export function LimitOrderBlock({ order, onCancel }: LimitOrderBlocProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="min-w-[250px] w-full flex flex-col p-4 rounded-lg border border-white/10 justify-start items-start gap-2.5"
    >
          ...
          <div className="justify-start items-center gap-2.5 flex">
            ...
            <div className="flex-col justify-start items-start gap-0.5 inline-flex">
              <div className="justify-start items-center gap-2 inline-flex">
                ...
                <div
                  className={`px-2 py-1 rounded-lg justify-center items-center gap-2 flex ${order.side === 'long' ? 'bg-greenSide/10' : 'bg-redSide/10'}`}
                >
                  <div
                    className={`text-center text-xs font-medium font-mono ${order.side === 'long' ? 'text-greenSide' : 'text-redSide'}`}
                  >
      ...
      >
        ...
        <div
          className={twMerge(
            ...
            isMini &&
              'col-span-2 col-start-1 row-start-3 w-1/2 justify-self-end',
            isMedium &&
              'col-span-2 col-start-2 row-start-2 w-1/2 justify-self-end',
            isCompact &&
              'col-span-2 col-start-2 row-start-2 w-1/2 justify-self-end',
