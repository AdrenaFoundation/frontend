...
export function LimitOrderBlock({ order, onCancel }: LimitOrderBlocProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="min-w-[250px] w-full flex flex-col p-4 rounded-md border border-white/10 justify-start items-start gap-2.5"
    >
          ...
          <div className="justify-start items-center gap-2.5 flex">
            ...
            <div className="flex-col justify-start items-start gap-0.5 inline-flex">
              <div className="justify-start items-center gap-2 inline-flex">
                ...
                <div
                  className={`px-2 py-1 rounded-md justify-center items-center gap-2 flex ${order.side === 'long' ? 'bg-greenSide/10' : 'bg-redSide/10'}`}
                >
                  <div
                    className={`text-center text-xs font-mono ${order.side === 'long' ? 'text-greenSide' : 'text-redSide'}`}
                  >
