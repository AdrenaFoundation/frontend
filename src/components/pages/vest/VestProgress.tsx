...
export default function VestProgress({
    ...
    return <div className="flex flex-col w-full">
        <div className={twMerge('w-full bg-third h-[1em] rounded items-center flex', className)}>
            <div className={twMerge("h-full bg-[#bd84cc] z-20")} style={{
                width: `${claimedAmountPercentage}%`,
            }} />

            <div className={twMerge("h-full bg-[#cec161] z-10")} style={{
