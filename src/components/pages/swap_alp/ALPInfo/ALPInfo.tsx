...
export default function ALPInfo({
  ...
  return (
    <div className="flex bg-gray-200 p-4 rounded-lg border border-gray-300 md:bg-transparent md:p-0 md:rounded-none md:border-none flex-col md:flex-row flex-wrap gap-5 w-full mt-5">
      ...
      <div className="flex flex-row justify-between md:flex-col md:justify-normal md:bg-gray-200 md:border md:border-gray-300 md:rounded-lg md:p-4 flex-1">
        <p className="text-base md:text-sm opacity-50 mb-3">Staked</p>
