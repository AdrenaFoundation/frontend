...
export default function ALPInfo({
  ...
  return (
    <div className="flex bg-gray-300 p-4 rounded-2xl border border-gray-200 md:bg-transparent md:p-0 md:rounded-none md:border-none flex-col md:flex-row flex-wrap gap-0 md:gap-5 w-full mt-5 z-20">
      <div className="flex flex-row justify-between md:flex-col md:justify-normal md:bg-gray-300/85 md:backdrop-blur-md md:border md:border-gray-200 md:rounded-2xl md:p-4 flex-1">
      ...
      <div className="flex flex-row justify-between md:flex-col md:justify-normal md:bg-gray-300/85 md:border md:border-gray-200 md:backdrop-blur-md md:rounded-2xl md:p-4 flex-1">
