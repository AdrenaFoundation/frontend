...
export default function OwnerBloc({
  ...
  return (
    <StyledContainer className={twMerge(className)}>
      <div className="flex h-[7em] w-[20em] w-full h-full items-center justify-center pb-4">
        {nicknameUpdating ? (
          <div className="flex flex-col items-center w-full justify-center">
            <InputString
              className="flex w-full border rounded-lg bg-inputcolor text-center justify-center"
      ...
      <StyledSubSubContainer className="flex-col">
        <div className="flex w-full items-start justify-between">
          <div className="text-sm">Profile Creation date</div>
          <DateInfo
        ...
        <div className="flex w-full items-center justify-between">
          <div className="text-sm">owner&apos;s wallet</div>
          <OnchainAccountInfo
        ...
        <div className="flex w-full items-center justify-between">
          <div className="text-sm">onchain profile account</div>
          <OnchainAccountInfo
            className="text-[0.7em] ml-1"
