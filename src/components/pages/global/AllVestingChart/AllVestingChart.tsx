    ...
    return (
      <Tippy content={<div className='flex flex-col items-center min-w-[12em]'>
        ...
        <div className='flex items-center justify-between w-full'>
          ...
          <div className='text-sm font-medium'>{startUnlockTimestamp.toLocaleDateString()}</div>
        </div>

        <div className='flex items-center justify-between w-full'>
          <div className='text-txtfade pr-2 text-sm'>End Unlock:</div>

          <div className='text-sm font-medium'>{endUnlockTimestamp.toLocaleDateString()}</div>
        </div>
      </div>}>
