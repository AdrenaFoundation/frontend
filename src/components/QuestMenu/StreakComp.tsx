    ...
    return (
        <div className={twMerge('flex flex-col justify-center w-full gap-2.5', className)}>
            <div className='flex w-full justify-between items-center'>
                ...
                <div>
                    <div className='flex gap-1'>
                        <div className="text-[0.8em] font-medium">Trade Daily</div>

                        <div className='font-medium text-xs text-[#e47dbb]'>
                            +0.7 mutagen
                        </div>
                    </div>
                ...
                <div className='flex'>
                    {streak.status === 0 ? (
                        <div className='text-xs font-medium'>Initialize your streak before reset</div>
                    ) : streak.status === 1 ? (
                        <div className='text-xs font-medium text-green'>Streak initialized</div>
                    ) : streak.status === 2 ? (
                        <div className='text-xs font-medium text-green'>Current streak: {streak.currentDaysStreak} days</div>
                    ) : (
                        <div className='text-xs font-medium text-redbright'>Careful, your will lose your {streak.currentDaysStreak} days streak</div>
                    )}
                </div>
            </div>
            ...
            <div className='flex w-full justify-between items-center'>
                <div>
                    <div className='flex gap-1'>
                        <div className="text-[0.8em] font-medium">Trade Weekly</div>
            ...
            <div className='flex w-full justify-between items-center'>
                <div>
                    <div className='flex gap-1'>
                        <div className="text-[0.8em] font-medium">Trade Monthly</div>
