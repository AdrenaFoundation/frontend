...
function getNotificationColors(type: string): { bg: string; border: string; accent: string } {
    switch (type) {
        case 'position_opened':
            return { bg: 'bg-green/10', border: 'border-green/30', accent: 'text-green' };
        ...
        default:
            return { bg: 'bg-gray/10', border: 'border-gray/30', accent: 'text-gray' };
    }
}
...
export const NotificationItem = ({
    ...
    // Calculate P&L
    const pnl = Number(notification.profit_usd_decimal || notification.loss_usd_decimal || 0);
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-2 gap-3 mb-3 text-sm">
                ...
                {['position_opened', 'position_increased'].includes(notification.notification_type) && (
                    <>
                        <div>
                ...
                {['position_closed', 'position_liquidated'].includes(notification.notification_type) && (
                    <>
                        <div>
