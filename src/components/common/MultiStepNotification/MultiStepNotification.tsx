      ...
      >
        <div className="flex flex-col h-full w-full">
          <div className="flex w-full justify-between p-2 px-3">
            <h3 className="font-medium capitalize">{this.title ?? 'Title'}</h3>
          ...
          {this.report_code !== null ? (
            <div className="flex flex-col gap-3 p-2 px-3">
              <div>
                <p className="mb-1 text-sm font-medium bg-[linear-gradient(110deg,#5AA6FA_40%,#B9EEFF_60%,#5AA6FA)] animate-text-shimmer bg-clip-text text-transparent bg-[length:250%_100%]">
                  Report code:{' '}
                ...
                <div className="h-full min-w-[11em] w-full flex flex-col justify-center gap-1 max-h-full overflow-auto">
                  {this.steps.map((step, index) => (
                    ...
                    >
                      ...
                      <div
                        className={twMerge(
                          'flex flex-row items-center gap-2 w-auto text-sm font-medium text-nowrap max-w-full overflow-hidden transition duration-500',
                          step.state === NotificationStepState.inProgress &&
                ...
                <>
                  <div className="flex flex-col gap-3 justify-between w-full p-1">
                    <div className="flex flex-row gap-2 items-center">
                      ...
                      <p
                        className={twMerge(
                          'text-sm font-medium text-redbright w-full h-full',
