    ...
    >
      <div className="flex flex-col mb-3">
        ...
        <DisplayInfo
          ...
          body={
            <div>
              Speed up your transactions with Dynamic Priority Fees following
              the market rate.
            </div>
          }
        />
        ...
        >
          ...
          <InfoAnnotation
            className="w-3 h-3"
            text={
              'The Medium/High/Ultra options are based on the 55th/75th/90th percentile of the current market rate.Accurate values are fetched right before each transaction.'
            }
          />
        </div>
