      ...
      {enhancedWallets.length > 0 || enhancedWalletData?.address ? (
        <div className="w-full flex flex-col">
          ...
          {enhancedWallets.filter((wallet) => wallet.isEmbedded).length > 0 && (
            <>
              {enhancedWallets
                .filter((wallet) => wallet.isEmbedded)
                .map((enhancedWallet) => {
                    ...
                    <div
                      ...
                      style={
                        isActive
                          ? {
                              background:
                                'linear-gradient(90deg, rgba(26, 27, 58, 0.8), rgba(47, 60, 126, 0.6), rgba(91, 62, 168, 0.5))',
                            }
                          : undefined
                      }
                    >
                  ...
                  {user &&
                    (() => {
                      const accountsWithDates = user.linkedAccounts
                        ...
                        .sort((a, b) => {
                          const dateA = a.firstVerifiedAt
                            ? new Date(a.firstVerifiedAt).getTime()
                            : 0;
                          const dateB = b.firstVerifiedAt
                    ...
                    .map((linkedAccount) => {
                      ...
                      const walletDisplayData = matchingEnhanced
                        ...
                        : {
                            ...
                            displayName:
                              linkedAccount.address.slice(0, 4) +
                              '...' +
                              linkedAccount.address.slice(-4),
                            walletName:
                              linkedAccount.walletClientType ||
                              'Unknown Wallet',
                      ...
                      return (
                        <div
                          key={`privy-linked-${linkedAccount.address}`}
                          ...
                          const getAccountIcon = () => {
                            switch (account.type) {
                              ...
                              default:
                                return (
                                  <svg
                                    className="w-8 h-8 text-txtfade"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                  >
          ...
          {enhancedWallets.filter((wallet) => !wallet.isEmbedded).length >
            0 && (
            <>
              <div className="pb-3 mt-4">
                <div className="text-sm font-bold text-white">
                    ...
                    <div
                      ...
                      style={
                        isActive
                          ? {
                              background:
                                'linear-gradient(90deg, rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.05))',
                            }
                          : undefined
                      }
                    >
        ...
        <div className="flex-1 p-3">
          <div className="font-medium text-lg sm:text-sm">
