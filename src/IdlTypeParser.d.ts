...
import type {
  ...
  IdlTypeDef,
  IdlTypeDefTyStruct,
} from '@coral-xyz/anchor/anchor/dist/cjs/idl.js';
import type {
  AccountMeta,
  PublicKey,
  Transaction,
...
//
// Code extracted from @saberhq/anchor-contrib
// https://github.com/saber-hq/saber-common/blob/master/packages/anchor-contrib/src/types.ts
//
