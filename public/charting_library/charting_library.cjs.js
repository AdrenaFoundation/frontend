...
Object.defineProperty(exports, '__esModule', { value: !0 }),
  ...
  ((W = exports.OrderStatus || (exports.OrderStatus = {}))[(W.Canceled = 1)] =
    'Canceled'),
  (W[(W.Filled = 2)] = 'Filled'),
  (W[(W.Inactive = 3)] = 'Inactive'),
  (W[(W.Placing = 4)] = 'Placing'),
  (W[(W.Rejected = 5)] = 'Rejected'),
  (W[(W.Working = 6)] = 'Working'),
  ((x = exports.OrderStatusFilter || (exports.OrderStatusFilter = {}))[
    (x.All = 0)
  ] = 'All'),
  (x[(x.Canceled = 1)] = 'Canceled'),
  (x[(x.Filled = 2)] = 'Filled'),
...
var he, ge, ue, Ce, pe, Se, me, ye, _e, Te, be, Pe, Le, Ae, we;
function fe(e, t) {
  const i = { ...e };
  for (const o in t)
...
!(function (e) {
  ...
  ((_e = exports.HHistDirection || (exports.HHistDirection = {})).LeftToRight =
    'left_to_right'),
  ...
  _render(e, t) {
    ...
    const r = (function (e, t) {
      ...
      const o = new URL(`${e || ''}`, location.href).href,
        ...
        a =
          null !== (i = Ie.find((e) => e.language === n)) && void 0 !== i
            ? i
            : { iso: 'en', dir: 'ltr' },
