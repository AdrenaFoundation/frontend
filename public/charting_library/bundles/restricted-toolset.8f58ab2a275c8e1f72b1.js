  ...
  [5516, 3718],
  {
    ...
    84264: (e, t, a) => {
      ...
      class h extends n.PureComponent {
        render() {
          const { reference: e, size: t, intent: a, ...s } = this.props,
            o = i(l().input, -1 !== this.props.tabIndex && l().focus);
          return n.createElement(
            'div',
            ...
            n.createElement(
              ...
              n.createElement('div', { className: l().switcherThumb }),
            ),
          );
        }
      }
      ...
      function m(e) {
        const {
          ...
          b = s()(v.label, a && !u && v.labelOn),
          S = s()(t, v.wrapper, a && v.wrapperWithOnLabel);
        return n.createElement(
          'label',
    ...
    40916: (e, t, a) => {
      'use strict';
      a.r(t), a.d(t, { getRestrictedToolSet: () => nn });
      var n = a(27490),
        i = a(67294),
        s = a(45697),
        o = a(79881),
      ...
      class b extends i.PureComponent {
        render() {
          ...
          return i.createElement('div', { className: p(t, g.wrap), ...a }, e);
        }
      }
      var S = a(47218),
        C = a(74818),
      ...
      class w extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(S.ToolWidgetButton, {
            ...
            className: p(r, _.button, { [_.first]: e, [_.last]: t }),
          });
        }
      }
      var f = a(10869),
            ...
            (e) => {
              ...
              return i.createElement(
                ...
                i.createElement(
                  ...
                  t,
                  !!s.length && i.createElement(f.PopupMenuSeparator, null),
                  s,
                ),
              );
            },
      ...
      class B extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(L, {
            ...
            collapseWhen: P.hasNewHeaderToolbarStyles
              ? ['full', 'medium', 'small']
              : void 0,
          });
        }
      ...
      const de = {
        ...
        ue = (0, K.hotKeySerialize)({ keys: ['/'], text: '{0}' }),
      ...
      class pe extends i.PureComponent {
        ...
        componentDidMount() {
          ...
          e.visible().subscribe(this._setActiveState),
            ...
            re.on('TVScriptRenamed', this._handleScriptRenamed, null);
        }
        componentWillUnmount() {
          const { studyMarket: e } = this.props,
            { favoriteScriptsModel: t, chartWidgetCollection: a } =
          ...
          e.visible().unsubscribe(this._setActiveState),
            ...
            re.unsubscribe('TVScriptRenamed', this._handleScriptRenamed, null),
            (this._promise = null);
        }
        render() {
          const {
            ...
            { chartWidgetCollection: d } = this.context;
          return i.createElement(
            i.Fragment,
            null,
            i.createElement(
      ...
      function Ce(e) {
        return i.createElement(
          'div',
          { className: p(Se.value, { [Se.selected]: e.isSelected }) },
          e.value,
          e.metric,
        );
      }
      ...
      class ke extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            { className: p(ye.form, { [ye.interacting]: t }) },
            ...
            i.createElement(
              ...
              fe.INTERVALS.find((e) => e.name === n).label,
      ...
      function Ie(e) {
        const {
          ...
          p = (0, C.filterDataProps)(e),
          [g, b] = (0, Ee.useHover)(),
          S = i.useCallback(() => h(t), [h, t]),
      ...
      class Ke extends i.PureComponent {
        ...
        componentDidMount() {
          ...
          e.getOnChange().subscribe(this, this._handleChangeFavorites),
            ...
            Le.globalCloseDelegate.subscribe(this, this._handleGlobalClose);
        }
        componentWillUnmount() {
          const {
            favoriteIntervalsService: e,
          ...
          e.getOnChange().unsubscribe(this, this._handleChangeFavorites),
            ...
            Le.globalCloseDelegate.unsubscribe(this, this._handleGlobalClose);
        }
        ...
        _createIntervalForm(e) {
          if (this._customIntervals) {
            ...
            return [
              i.createElement(f.PopupMenuSeparator, {
        ...
        _renderResolutionsGroup(e, t = !1, a) {
          ...
          return (
            (!e.mayOmitSeparator || e.items.length > 1) &&
              ...
              n.push(
                i.createElement(f.PopupMenuSeparator, { key: 'end-' + e.name }),
              )),
            n
          );
        }
        ...
        _renderPopupMenuItem(e, t) {
          const { isFavoritingAllowed: a } = this.props,
            ...
            c = (0, ge.getTranslatedResolutionModel)(e);
      ...
      var Ge = a(51274),
        qe = a(19614);
      const Xe = { hint: (0, o.t)('Open chart in popup') },
      ...
      Ze.contextType = Qe;
      var je = a(84050);
      const Je = { hint: (0, o.t)('Chart Properties') },
      ...
      class rt extends i.PureComponent {
        ...
        render() {
          const {
            ...
            c = p(nt.container, s, h && nt.hovered, {
      ...
      class ft extends i.PureComponent {
              ...
              t
                ? i.createElement(
                    ...
                    i.createElement(L, {
                      id: e,
                      displayMode: a,
                      icon: i.createElement(d.Icon, { icon: mt }),
                      isDisabled: n,
        ...
        _renderMenuItems(e) {
          const {
            ...
            _ = e ? void 0 : (0, G.humanReadableHash)(G.Modifiers.Mod + 83),
      ...
      class kt extends i.PureComponent {
        ...
        componentDidMount() {
          ...
          t
            ...
            : (i.getOnChange().subscribe(this, this._onChangeHasChanges),
              ...
              (this._hotkeys = (0, et.createGroup)({ desc: 'Save/Load' })),
              this._hotkeys.add({
        ...
        componentWillUnmount() {
          ...
          t
            ...
            : (i.getOnChange().unsubscribe(this, this._onChangeHasChanges),
              ...
              (0, $.ensureDefined)(this._hotkeys).destroy(),
        ...
        render() {
          ...
          return i.createElement(
            y.MatchMedia,
            { rule: k.DialogBreakpoints.TabletSmall },
            (e) => i.createElement(ft, { ...u, isTabletSmall: e }),
          );
        }
        _onLoginStateChange() {
          ...
          const n = URL.createObjectURL(
            new Blob(
              [
                ...
                }"><head><meta charset="utf-8"><title>${Nt}</title></head><body style="background-color:${
        ...
        const { serverSnapshot: t, clientSnapshot: n } = e,
            ...
            async (e = !1) => {
              ...
              try {
                if (e) await b(a);
                  ...
                  await (0, Ft.writePromiseUsingApi)(e, 'text/plain'),
                    re.emit('onServerScreenshotCopiedToClipboard');
                }
                return !0;
              } catch (e) {
                return b(a), !0;
          ...
          C = (0, i.useCallback)(async () => {
            ...
            const [e, n] = await Promise.all([
              a.e(4665).then(a.bind(a, 59248)),
              t(),
            ]);
            e.Twitter.shareSnapshotInstantly(n.symbol, n.imageUrl),
              m.current && (d(!1), (0, Le.globalCloseMenu)());
          }, [t]);
        return i.createElement(
          i.Fragment,
          null,
          i.createElement(u.PopupMenuItem, {
            ...
            icon: Ot,
            onClick: g,
            shortcut: (0, G.humanReadableHash)(
          ...
          constructor(e, t) {
            super(e, t),
              ...
              (this._serverSnapshot = async () => {
                ...
                return { symbol: (0, Tt.shortName)(e), imageUrl: a };
              }),
              (0, E.validateRegistry)(t, {
                chartWidgetCollection: s.any.isRequired,
              });
      ...
      class sa extends i.PureComponent {
                ...
                try {
                  (0, D.trackEvent)('GUI', 'SS', 'main search'),
                    await new ta().show({
                      ...
                      showSpreadActions:
                        (0, $t.canShowSpreadActions)() &&
                        this.props.isActionsVisible,
                      source: 'searchBar',
                      footer: Te.mobiletouch
                        ? void 0
                        : i.createElement(
                            Yt.SymbolSearchDialogFooter,
                            null,
                            (0, o.t)(
        ...
        render() {
          ...
          return i.createElement(S.ToolWidgetButton, {
            ...
            className: v()(
              t,
              n.enabled('uppercase_instrument_names') && aa.uppercase,
            ),
            theme: ia,
            icon: void 0,
      ...
      function ba(e) {
        const {
          ...
          [h, d] = (0, Ee.useHover)(),
          m = t.meta_info,
          p = m ? (0, ha.descriptionString)(m.indicators) : void 0,
          g = r ? pa : ma,
          b = r ? ga : va,
        ...
        return i.createElement(u.PopupMenuItem, {
          ...
          label: i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(d.Icon, { className: Ca.icon, icon: Sa }),
              i.createElement('div', { className: Ca.text }, wa.text),
            ),
          ),
          onClick: t,
        });
      ...
      function Ta(e) {
        ...
        return i.createElement(
          ...
          i.createElement(fa, { onClick: n, isTabletSmall: r }),
          h &&
            i.createElement(
              i.Fragment,
              null,
              i.createElement(f.PopupMenuSeparator, null),
              i.createElement(se, null),
            ),
          !h &&
            (r
              ? i.createElement(xa, { defaults: c, customs: d, render: b })
              : i.createElement(Ia, {
                  defaults: c,
                  customs: d,
                  render: b,
      ...
      function Pa(e) {
        const {
          ...
          p = o.filter((e) => s.includes(e.name)),
          g = 'small' !== n && c && p.length > 0;
        return i.createElement(
          b,
          { id: t, className: u },
          i.createElement(
      ...
      const Ga = {
        ...
        Za = { ...Ba, button: Xa.buttonUndo },
        ja = { ...Ba, button: Xa.buttonRedo },
    ...
    1495: (e, t, a) => {
      ...
      var n = a(27292),
        ...
        h = a(24631),
        c = a(60554);
      const d = { 3: n, 0: i, 1: s, 8: o, 9: l, 2: r, 10: h, 12: c };
    },
    84629: (e, t, a) => {
      'use strict';
