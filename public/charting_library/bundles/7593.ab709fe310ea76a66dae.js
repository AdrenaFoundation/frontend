...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7593],
  {
    ...
    72491: (e, t, i) => {
      ...
      i.d(t, {
        convertFromReadonlyWVToDefinitionProperty: () => U,
        ...
        createEmojiPropertyDefinition: () => W,
        ...
        createOptionsPropertyDefinition: () =>
          d.createOptionsPropertyDefinition,
        createPropertyDefinitionsCheckableListOptionsGroup: () => _,
        ...
        destroyDefinitions: () => le,
        getColorDefinitionProperty: () => $,
        getLockPriceScaleDefinitionProperty: () => q,
        getPriceScaleSelectionStrategyDefinitionProperty: () => B,
        getScaleRatioDefinitionProperty: () => J,
        getSymbolDefinitionProperty: () => ee,
        isCheckableListOptionsDefinition: () => pe,
        isColorDefinition: () => ne,
        isLineDefinition: () => re,
        isOptionsDefinition: () => se,
        isPropertyDefinition: () => te,
        isPropertyDefinitionsGroup: () => ie,
        isTwoColorDefinition: () => oe,
      ...
      function H(e, t, i, r) {
        return {
          ...
          visible: r,
          groupType: 'general',
          definitions: new N.WatchedValue(e),
        };
      }
      function _(e, t, i, r, n) {
        return {
          ...
          definitions: new N.WatchedValue(t),
      ...
      function J(e, t, i, r) {
        const n = (0, F.makeProxyDefinitionProperty)(t.weakReference(), r);
        return (
          (n.setValue = (r) => {
      ...
      function Z(e, t) {
        if ((0, Q.isHexColor)(e)) {
          const i = (0, K.parseRgb)(e);
          return (0, K.rgbaToString)((0, K.rgba)(i, (100 - t) / 100));
        }
        return e;
      }
      function $(e, t, i, r, n) {
        let o;
        if (null !== i) {
          const e = (0, X.combineProperty)(
            Z,
            t.weakReference(),
            i.weakReference(),
          );
          o = (0, F.makeProxyDefinitionProperty)(e.ownership());
        } else
          o = (0, F.makeProxyDefinitionProperty)(t.weakReference(), [
            () => Z(t.value(), 0),
            (e) => e,
          ]);
        return (
      ...
      function ee(e, t, i, r, n, o) {
        ...
        var p, l;
        const c = (0, F.convertToDefinitionProperty)(e, t, n, s);
        o && (c.setValue = o);
        const a = new Map();
        (c.subscribe = (e, i) => {
          const r = (e) => {
