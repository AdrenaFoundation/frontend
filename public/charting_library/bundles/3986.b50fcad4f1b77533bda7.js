  ...
  [3986],
  {
    32766: (e, i, t) => {
      ...
      const u = new o.TranslatedString(
        ...
        h =
          (new o.TranslatedString(
            'change use volume weighted bars',
            n.t(null, void 0, t(95108)),
          ),
          new o.TranslatedString(
            'change HLC bars',
        ...
        return (0, r.createOptionsPropertyDefinition)(
          {
            disabled:
              a &&
              (0, r.convertFromReadonlyWVToDefinitionProperty)(a.ownership()),
      ...
      function Pe(e, i, d, u, g) {
        ...
        return (
          u.isJapaneseChartsAvailable && s.enabled('japanese_chart_styles'), []
        );
      }
      function Te(e) {
        return !('inputs' in e);
              ...
              f.push(
                (0, s.createOptionsPropertyDefinition)(
                  ...
                  },
                  {
                    id: `${g}${l.name}`,
                    title: P,
                    options: new a.WatchedValue(y(i)),
                  },
                ),
              );
              ...
              if ('float' === l.type) {
                ...
                return (
                  (t =
                    (function (e, i) {
                      return !(
                        ((i === (0, d.chartStyleStudyId)(4) ||
                          i === (0, d.chartStyleStudyId)(6)) &&
                          'boxSize' === e) ||
                        (i === (0, d.chartStyleStudyId)(5) &&
                          'reversalAmount' === e)
                      );
                    })(S, i) || null === v.value()
                    ...
                    r = (0, s.createOptionsPropertyDefinition)(
                      ...
                      },
                      {
                        ...
                        options: new a.WatchedValue(
                          this._timezonePropertyObj.values,
                        ),
                      },
                    );
                  return (
          ...
          if (m) {
            const t = this._series.sessionIdProxyProperty(),
              n = (0, w.combineWithFilteredUpdate)(
                (e, i) =>
                  !i &&
                  (0, d.symbolHasSeveralSessions)(this._series.symbolInfo()),
                (e, i) => i || !e,
                this._series.symbolResolvingActive().weakReference(),
                (0, S.createWVFromProperty)(
