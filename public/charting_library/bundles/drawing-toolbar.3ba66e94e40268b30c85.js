    ...
    37159: (e, t, o) => {
      ...
      function B(e) {
        ...
        return n.createElement(A, {
          id: t,
          icon: p.lineToolsInfo[a].icon,
          isActive: i,
          isHidden: l,
          isTransparent: s,
          onClick: o,
          tooltip: p.lineToolsInfo[a].localizedName,
          'data-name': a,
        });
      }
      var I,
      ...
      const be = o(11121),
        fe = (0, n.forwardRef)((e, t) => {
          const {
              ...
              onMenuKeyDown: x = ge.handleAccessibleMenuKeyDown,
              ...E
            } = e,
          ...
          function U() {
            if (r.mobiletouch && !g) !D.current && f && f();
            else {
              if (N.current)
      ...
      class pt extends n.PureComponent {
              ...
              s.map((s, a) => {
                ...
                const { name: h } = s,
                  m =
                    null ===
                      (d =
                        null === (u = p.lineToolsInfo[h]) || void 0 === u
                          ? void 0
                ...
                return n.createElement(dt.AccessibleMenuItem, {
                  ...
                  onClick: g ? this._handleGrayedClick : this._handleClickItem,
                  onClickArg: h,
        ...
        _firstNonGrayedTool() {
          ...
          return null === (e = o.find((e) => gt(e) && !t[e.name])) ||
            void 0 === e
            ? void 0
            : e.name;
        }
      ...
      function Bt(e) {
        ...
        const r = p.lineToolsInfo.hideAllDrawings,
          {
            trackLabel: c,
            tooltip: u,
            dataName: d,
      ...
      const vo = u.enabled('right_toolbar'),
        go = u.enabled('keep_object_tree_widget_in_right_toolbar'),
        po = (0, v.onWidget)(),
        bo = new m.Delegate(),
      ...
      class wo extends n.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._features = {
              ...
              tools: !po || u.enabled('charting_library_base'),
            }),
            (this._registry = {
        ...
        render() {
          ...
          const h = () =>
            ...
            !(!u.enabled('show_object_tree') || (go && !vo));
          return n.createElement(
            ho.RegistryProvider,
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [
                !(0, i.onWidget)() && l.enabled('image_drawingtool')
                  ? { name: 'LineToolImage' }
                  : null,
                null,
                null,
