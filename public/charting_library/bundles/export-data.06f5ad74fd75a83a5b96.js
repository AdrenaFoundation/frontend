    ...
    99992: (e, l, t) => {
      ...
      function m(e, l = {}) {
        const t = Object.assign({}, p, l),
          ...
          x = (0, i.ensureNotNull)(r.symbolInfo()),
          N = (0, h.getChartWidgetApiTimeConverter)(r.interval(), x, e),
          V =
            !l.includeOHLCValuesForSingleValuePlots &&
            (0, d.isCloseBasedSymbol)(x),
          I = (function (e, l) {
            const t = e
              .allStudies()
              .filter((e) => e.showInObjectTree() && e.isVisible());
            if ('all' === l) return t;
            return t.filter((e) => l.includes(e.id()));
          })(e, t.includedStudies),
          O = [];
        for (const e of I) {
        ...
        const b = I.map((e) => e.data());
        (t.includeSeries || 0 === b.length) && b.push(r.bars());
        const w = (function (e, l, t, s, n) {
              ...
              for (let e = 0; e < l.length; e++) {
                const i = l[e],
                  u = s.includeOffsetStudyValues
                    ...
                    : 0,
                  d = i.search(h, a.PlotRowSearchMode.NearestRight);
                null !== d && d.index < m && (m = d.index);
                const r = i.search(p, a.PlotRowSearchMode.NearestLeft);
                null !== r && r.index + u > g && (g = r.index + u);
              }
              return (
                (0, i.assert)(
                  m <= g,
        ...
        let B = s.schema.length;
        for (const e of O) s.schema.push(...e.fields);
        const L = s.schema.length;
        if (0 === L) return s;
        for (let e = D; e <= F; ++e) {
          const l = new Float64Array(L);
          l.fill(NaN),
            s.data.push(l),
            s.indexes.push(e),
            t.includeDisplayedValues &&
              s.displayedData.push(new Array(L).fill(''));
        }
        if (t.includeTime || t.includeUserTime) {
          ...
          for (let e = D; e <= F; ++e) {
            ...
            if (
              (t.includeTime && (s.data[e - D][0] = (0, i.ensureNotNull)(o)),
              t.includeUserTime && (s.data[e - D][C] = a.getTime() / 1e3),
              t.includeDisplayedValues)
            ) {
              const i = l.format(a);
              t.includeTime && (s.displayedData[e - D][0] = i),
                t.includeUserTime && (s.displayedData[e - D][C] = i);
            }
          }
        }
        if (t.includeSeries) {
          const e = r.bars().range(D, F),
          ...
          e.each((e, l) => {
            const o = s.data[e - D],
              u = v(l[4]);
            if (V) {
              if (((o[_] = u), t.includeDisplayedValues)) {
                s.displayedData[e - D][_] = i(u);
              }
            } else if (S) {
              const u = n(l);
              if (((o[_] = u), t.includeDisplayedValues)) {
              ...
              if (
                ...
                const l = s.displayedData[e - D];
                12 === m
                  ? ((l[_] = i(a)), (l[_ + 1] = i(d)))
                  : 16 === m
                    ? ((l[_] = i(a)), (l[_ + 1] = i(d)), (l[_ + 2] = i(u)))
                    : ((l[_] = i(n)),
                      (l[_ + 1] = i(a)),
                      (l[_ + 2] = i(d)),
                      (l[_ + 3] = i(u)));
          ...
          for (let e = 0; e < u.fields.length; ++e) {
            ...
            n.data()
              ...
              .each((e, l) => {
                ...
                let u;
                return (
                  (u = r ? v(l[4]) : f ? (0, i.ensureDefined)(a)(l) : v(l[h])),
                  (n[g] = u),
                  t.includeDisplayedValues &&
