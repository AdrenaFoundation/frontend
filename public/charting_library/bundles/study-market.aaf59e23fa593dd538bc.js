  ...
  [6456],
  {
    ...
    53234: (e) => {
      e.exports = {
        ...
        'highlight-animation-theme-light':
          'highlight-animation-theme-light-3Ywm3-oo',
        dark: 'dark-3Ywm3-oo',
        'highlight-animation-theme-dark':
          'highlight-animation-theme-dark-3Ywm3-oo',
        badge: 'badge-3Ywm3-oo',
        main: 'main-3Ywm3-oo',
    ...
    44809: (e) => {
      e.exports = {
        ...
        contentContainer: 'contentContainer-3kc5LZDR',
        ...
        tabWithHint: 'tabWithHint-3kc5LZDR',
        solution: 'solution-3kc5LZDR',
      };
    },
    1386: (e) => {
      e.exports = {
    ...
    80511: (e, t, n) => {
      ...
      function d(e) {
        ...
        return i.createElement(
          ...
          s && i.createElement('span', { className: l().content }, s),
          c &&
            !o &&
            'xsmall' !== t &&
            i.createElement(a.Icon, {
      ...
      function p(e) {
        const { reference: t, ...n } = e,
          ...
          } = (0, i.useContext)(u.ControlGroupContext),
          s = c({
            ...n,
            isGrouped: r,
            cellState: o,
      ...
      function E(e) {
        return i.createElement(p, { ...b(e) });
      }
    },
    94618: (e, t, n) => {
      'use strict';
      n.d(t, { ControlGroupContext: () => i });
      const i = n(67294).createContext({
        isGrouped: !1,
    ...
    40834: (e, t, n) => {
      ...
      var i = n(67294),
        ...
        c = n(6960);
      function d(e) {
        const { children: t, renderInput: n, onCancel: r, ...d } = e;
        return i.createElement(
          'div',
          ...
          t,
          i.createElement(s.Icon, { className: c.icon, icon: l }),
          r &&
            i.createElement(
              'div',
              { className: c.cancel, onClick: r },
              (0, a.t)('Cancel'),
            ),
        );
      }
    ...
    45745: (e, t, n) => {
      ...
      function d(e) {
        const { mode: t, className: n, ...r } = e,
          { isMobile: a, isTablet: s } = c(t),
          d = o()(l.container, s && l.isTablet, a && l.isMobile, n);
      ...
      function u(e) {
        return i.createElement('div', { className: l.wrapper, ...e });
      }
      function h(e) {
        const { mode: t, title: n, icon: r, isActive: d, onClick: u, ...h } = e,
          { isMobile: m, isTablet: p } = c(t);
        return i.createElement(
          'div',
          {
            ...h,
          ...
          i.createElement(a.Icon, { className: l.icon, icon: r }),
          !p &&
            i.createElement(
              'span',
              { className: l.title },
              i.createElement('span', { className: l.titleText }, n),
              m && i.createElement(a.Icon, { className: l.nested, icon: s }),
            ),
        );
      }
    },
    36108: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { IndicatorsLibraryContainer: () => U });
      var i = n(67294),
        r = n(73935),
        o = n(79881),
        a = n(15521),
      ...
      function m(e) {
        ...
        const {
          ...
          m =
            (null == u ? void 0 : u.isChartPattern) ||
            n.includes('CP@tv-basicstudies')
              ? 'chart-patterns'
              : l().getPackageName(n);
        return {
          id: n,
          title: a || (0, o.t)(i, { context: 'study' }),
          shortDescription: r,
          shortTitle: r,
      ...
      function C(e) {
        ...
        return i.createElement(
          'span',
          { className: g()(w.title, r && w.disabled, n) },
          t,
        );
      }
      ...
      function L(e) {
        const t = (0, i.useContext)(R),
          ...
          { isFavorite: b, isLocked: E, public: y, editorsPick: x } = a,
          _ = void 0 !== b,
          w = P(v, a),
          D = (0, i.useCallback)((e) => e.stopPropagation(), []),
          L = (null == t ? void 0 : t.toggleFavorite)
            ? P(t.toggleFavorite, a)
            : void 0,
          O =
            (0, S.useWatchedValueReadonly)({ watchedValue: N.watchedTheme }) ===
            I.StdTheme.Dark
              ? T.dark
              : T.light,
          B = g()(
            T.container,
            a.isGrayed && T.disabled,
            h && T.selected,
            m && T.highlighted,
            m && O,
          );
        return i.createElement(
          'div',
          {
            ...
            style: n,
            'data-role': 'list-item',
            'data-disabled': a.isGrayed,
            'data-title': a.title,
            'data-id': a.id,
          },
          i.createElement(
            'div',
            { className: g()(T.main, !_ && T.paddingLeft) },
            _ &&
              i.createElement(F.FavoriteButton, {
                className: g()(T.favorite, b && T.isActive),
                isFilled: b,
                onClick: L,
              }),
            i.createElement(
              C,
              { disabled: a.isGrayed },
              i.createElement(k.HighlightedText, {
                queryString: s,
                rules: l,
                text: a.title,
              }),
            ...
            !1,
            c &&
              i.createElement(BadgeIndicator, {
                type: 'beta',
                className: T.badge,
              }),
            d &&
          ...
          'mobile' !== r &&
            y &&
            i.createElement('span', { className: T.likes }, y.likesCount),
          !1,
        );
      }
      function P(e, t) {
        return (n) => {
          const i = 0 === (0, D.modifiersFromEvent)(n) && 0 === n.button;
      ...
      function M(e) {
        ...
        return i.createElement('div', { style: t, className: z.container }, n);
      }
      var Y = n(49775),
        A = n(80511),
        q = n(1386);
      function Z(e) {
        ...
        return i.createElement(
          'div',
          { className: g()(q.container, t) },
          n && i.createElement(Y.Icon, { icon: n, className: q.image }),
          r && i.createElement('h3', { className: q.title }, r),
          o && i.createElement('p', { className: q.description }, o),
          a &&
            s &&
            i.createElement(A.Button, { onClick: s, className: q.button }, a),
        );
      }
      function H(e) {
      ...
      function G(e) {
        const {
          ...
          [l, c] = (0, i.useState)(''),
          d = (0, i.useMemo)(() => (0, W.createRegExpList)(l, h), [l]),
          u = (0, i.useMemo)(
            () =>
              l
                ? (0, W.rankedSearch)({
        ...
        return (
          ...
          i.createElement(f.AdaptivePopupDialog, {
            isOpened: r,
            onClose: a,
            onClickOutside: a,
            className: g()(V.dialogLibrary),
            render: function () {
              return i.createElement(
                i.Fragment,
                null,
                i.createElement(E.DialogSearch, {
                  reference: C,
                ...
                i.createElement(
                  y.DialogSidebarWrapper,
                  null,
                  i.createElement(
                    _,
                    { reference: w, className: V.scroll },
                    S
                      ? i.createElement(v.Spinner, null)
                      : u.length
                      ? i.createElement(
                          i.Fragment,
                          null,
      ...
      class U extends class {
          ...
          e.isGrayed
            ...
            : (b.CheckMobile.any() ||
              ...
              (async function (e, t, n, i, r) {
                ...
                e,
                null !== (i = this._parentSource) && void 0 !== i ? i : void 0,
                0,
                this._symbol,
              ).then(() => {
                var e;
        ...
        _render() {
          ...
          r.render(i.createElement(G, { ...e }), t);
        }
      }
    },
    65043: (e, t, n) => {
                    ...
                    ? ((d = 3),
                      void (c =
                        null === (n = t.match(h)) || void 0 === n
                          ? void 0
                          : n.index))
                    : (0, i.isString)(t) && h.test(t)
                    ? ((d = 2),
                      void (c =
                        null === (a = t.match(h)) || void 0 === a
                          ? void 0
                          : a.index))
                    : (0, i.isString)(o) && h.test(o)
                    ? ((d = 1),
                      void (c =
                        null === (s = o.match(h)) || void 0 === s
                          ? void 0
                          : s.index))
                    : void (
                        (0, i.isString)(o) &&
                        ...
                        ((d = 1),
                        (c =
                          null === (l = o.match(u)) || void 0 === l
                            ? void 0
                            : l.index))
                      )
                );
              }),
              { matchPriority: d, matchIndex: c, item: e }
            );
          })
