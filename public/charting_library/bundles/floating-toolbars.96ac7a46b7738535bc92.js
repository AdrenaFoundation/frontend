  ...
  [2306],
  {
        ...
        return i.createElement(
          ...
          i.createElement(d.ColorPicker, {
            ...
            onColorChange: function (e, t) {
              const o = b
                ? (0, c.alphaToTransparency)((0, a.parseRgba)(b)[3])
                : 0;
        ...
        return (
          (0, i.useLayoutEffect)(() => {
            ...
            const e = (0, n.ensureNotNull)(t.current),
              o = () => {
                const o = (0, r.queryTabbableElements)(e).sort(
                  r.navigationOrderComparator,
                );
                if (
                  0 === o.length ||
                  (o[0].parentElement &&
                    !u(o[0].parentElement, (0, n.ensureNotNull)(t.current)))
                ) {
                  const i = (function (e) {
                    const o = d(e)
    ...
    35789: (e, t, o) => {
      ...
      const m = function (e, t, o) {
        t = (o ? (0, h.default)(e, t, o) : void 0 === t)
          ? 1
          : p((0, d.default)(t), 0);
            ...
            i.createElement(
              ...
              e.map((e, o) =>
                i.createElement(x, {
                  ...
                  color: e,
                  selected:
                    l && (0, g.areEqualRgb)(l, (0, g.parseRgb)(String(e))),
                  onSelect: c,
                  onSwatchRemove: s
                    ? () =>
                        (function (e, t) {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            {
              ...
              className: r()(
                l.PLATFORM_ACCESSIBILITY_ENABLED && z.accessible,
                e,
              ),
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handleKeyDown = (e) => {
              ...
              n({
                h: (0, M.clamp)(38 === r ? t - 0.01 : t + 0.01, 0, 1),
                s: o,
                v: i,
              });
            }),
        ...
        render() {
          ...
          return i.createElement(
            'div',
            {
              className: r()(
                W.hue,
                l.PLATFORM_ACCESSIBILITY_ENABLED && W.accessible,
                e,
              ),
              tabIndex: l.PLATFORM_ACCESSIBILITY_ENABLED ? 0 : -1,
              onKeyDown: this._handleKeyDown,
            ...
            (this._handlePosition = (e) => {
              null === this._raf &&
                (this._raf = requestAnimationFrame(() => {
                  ...
                  this.setState({
                    inputOpacity: Math.round(100 * a).toString(),
                  }),
          ...
          return i.createElement(
            ...
            i.createElement(
              'div',
              {
                className: n(
                  c.opacitySlider,
                  a.PLATFORM_ACCESSIBILITY_ENABLED && c.accessible,
                ),
                style: h,
    ...
    56512: (e, t, o) => {
      ...
      function a() {
        ...
        s('add_new_custom_color', (o) => t(c(o, e))),
          s('remove_custom_color', (o) => t(h(o, e)));
            ...
            (t) => {
              ...
              e.some(
                (e) =>
                  null !== e &&
                  null !== o &&
                  (0, l.areEqualRgb)((0, l.parseRgb)(e), o),
              ) ||
                (r.emit('add_new_custom_color', t),
                (0, n.setJSON)('pickerCustomColors', c(t, e)));
            },
            [e],
          ),
          a = (0, i.useCallback)(
            (t) => {
              (t >= 0 || t < e.length) &&
                ...
                (0, n.setJSON)('pickerCustomColors', h(t, e)));
            },
            [e],
          );
        return [e, o, a];
      ...
      class g extends n.FloatingToolbar {
        ...
        _createLinetoolWidget(e) {
          const t = `<span class="tv-favorited-drawings-toolbar__widget apply-common-tooltip ${
              ...
              h.lineToolsInfo[e].localizedName
            }" data-name="FavoriteToolbar${e}">${
    ...
    3809: (e, t, o) => {
      ...
      class y {
        ...
        _determineCurrentLayoutVertical(e) {
          ...
          return (
            window.innerWidth < t && window.innerWidth < window.innerHeight
          );
        }
        _getWidget() {
          return this._widget;
        ...
        return i.createElement(L.ToolWidgetIconButton, {
          ...
          onClick: async function () {
            ...
            1 === t
              ...
              : t > 1 &&
                (await o.showChartPropertiesForSources({ sources: e }));
          },
          'data-name': 'settings',
        });
      }
      ...
      function Y(e) {
                ...
                d().then((t) => {
                  ...
                  !R.isAnyMobile
                    ? H.ContextMenuManager.showMenu(
                        ...
                        e,
                        {
                          mode: R.isAnyMobile ? 'drawer' : 'menu',
                          'data-name': 'more-menu',
                        },
        ...
        return (
          (0, i.useEffect)(() => {
            var e;
            l.length &&
              (null === (e = c.current) || void 0 === e || e.update());
          }, [l]),
          i.createElement(
            V.ToolWidgetMenu,
            {
