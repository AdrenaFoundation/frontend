      ...
      const p = o.memo((e) => {
        ...
        return 'title' === a.type
          ? o.createElement(
              'div',
              { style: t },
              o.createElement(l, { title: a.relatedTitle }),
            )
          : o.createElement(
              'div',
              { style: t },
    ...
    81261: (e, t, n) => {
      ...
      function l(e) {
        ...
        const p = h(s),
          ...
          w = -1 !== f,
          E = (e) => {
            c && (0, r.becomeSecondaryElement)(c),
        ...
        switch ((0, o.mapKeyCodeToDirection)(n)) {
          case 'inlinePrev':
            if (!p.length) return;
            e.preventDefault(),
              E(0 === f ? l[d] : w ? m(p, f, -1) : p[p.length - 1]);
            break;
          case 'inlineNext':
            if (!p.length) return;
            e.preventDefault(),
              f === p.length - 1 ? E(l[d]) : E(w ? m(p, f, 1) : p[0]);
            break;
          case 'blockPrev': {
            e.preventDefault();
            const t = m(l, d, -1);
    ...
    54079: (e, t, n) => {
      ...
      const u = (0, o.forwardRef)(function (e, t) {
        const {
          ...
          p = c.PLATFORM_ACCESSIBILITY_ENABLED
          ...
          o.createElement('div', {
            ...
            onKeyDown: (0, a.createSafeMulticastEventHandler)(function (e) {
              ...
              const n = e.currentTarget,
                o = (0, c.queryFocusableElements)(n).sort(
                  c.navigationOrderComparator,
                );
