  ...
  [8537],
  {
    ...
    34412: (e, t, i) => {
      ...
      const d = new o.TranslatedString(
        ...
        L = n.t(null, void 0, i(4518)),
        C = n.t(null, void 0, i(89073)),
      ...
      function W(e, t, i, n) {
        ...
        const O = (0, l.createCheckablePropertyDefinition)(
          ...
          { id: `${o}BarsRange`, title: (n && n.barRange) || C },
        );
        if ((R.push(O), 'showDateTimeRange' in t)) {
          const r = (0, l.createCheckablePropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(
                e,
      ...
      class H extends a.LineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          ...
          const ne = (0, s.createOptionsPropertyDefinition)(
            ...
            { id: `${a}PitchStyle`, title: B, options: new d.WatchedValue(O) },
          );
          e.push(ne);
          const oe = (0, s.createTwoOptionsPropertyDefinition)(
            ...
            },
            {
              ...
              optionsItems2: new d.WatchedValue(I),
            },
          );
          e.push(oe);
          ...
          const ae = (0, s.createOptionsPropertyDefinition)(
            ...
            { id: `${a}FontSize`, title: R, options: new d.WatchedValue(F) },
          );
          if (
            (e.push(ae),
    ...
    23720: (e, t, i) => {
      ...
      class x extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          e.push(L);
          const C = (0, l.createTransparencyPropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(
                this._propertyApplier,
                t.fillBackground,
    ...
    49267: (e, t, i) => {
      ...
      class S extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          e.push(L);
          const C = (0, s.createCheckablePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(
                this._propertyApplier,
                t.showCoeffs,
    ...
    27340: (e, t, i) => {
      ...
      const d = new r.TranslatedString(
        ...
        L = o.t(null, void 0, i(65e3)),
        C = o.t(null, void 0, i(28971)),
    ...
    56641: (e, t, i) => {
      ...
      class b extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const C = (0, a.createColorPropertyDefinition)(
            {
              color: (0, a.getColorDefinitionProperty)(
                this._propertyApplier,
                new d.CollectibleColorPropertyUndoWrapper(
    ...
    26486: (e, t, i) => {
      ...
      const c = new o.TranslatedString(
        ...
        L = n.t(null, void 0, i(71525)),
        C = n.t(null, void 0, i(28357));
          ...
          return {
            definitions: [
              ...
              (0, s.createColorPropertyDefinition)(
                ...
                { id: `${i}FailureBackgroundColor`, title: C },
              ),
            ],
          };
        }
    ...
    2243: (e, t, i) => {
      ...
      const u = new o.TranslatedString(
        ...
        L = n.t(null, void 0, i(33310)),
        C = n.t(null, void 0, i(3560)),
        ...
        U = n.t(null, void 0, i(75106)),
        O = n.t(null, void 0, i(87145));
      function I(e) {
        return [
          { value: c.RiskDisplayMode.Percentage, title: U },
          { value: c.RiskDisplayMode.Money, title: e || O },
        ];
      }
      class F extends s.LineDataSourceDefinitionsViewModel {
        constructor(e, t) {
      ...
      class O extends l.StudyLineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          ...
          const O = this._source.properties().childs(),
            I = this._source.name(),
            F = (0, s.removeSpaces)(I),
            H = new o.TranslatedString(I, this._source.translatedType()),
            j = O.styles.childs().VWAP.childs(),
            Y = [
              (0, r.createLinePropertyDefinition)(
                {
                  color: (0, r.getColorDefinitionProperty)(
          ...
          if (
            ...
            const e = O.styles.childs().LowerBand.childs(),
              t = U(
                this._propertyApplier,
                e,
                p,
              ...
              i = O.styles.childs().UpperBand.childs(),
              n = U(
                this._propertyApplier,
                i,
                y,
          ...
          if (null == X ? void 0 : X.area) {
            const e = O.areaBackground.childs(),
          ...
          if (
            ...
            const e = O.styles.childs().LowerBand_2.childs(),
              t = U(
                this._propertyApplier,
                e,
                g,
              ...
              i = O.styles.childs().UpperBand_2.childs(),
              n = U(
                this._propertyApplier,
                i,
                w,
              ...
              o = O.styles.childs().LowerBand_3.childs(),
              r = U(
                this._propertyApplier,
                o,
                S,
              ...
              l = O.styles.childs().UpperBand_3.childs(),
              s = U(
                this._propertyApplier,
                l,
                x,
