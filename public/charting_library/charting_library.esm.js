...
var he, ge, ue, Ce, Se, pe, me, _e, ye, Te, be, Pe, Le, fe, we;
function Ae(e, t) {
  const i = { ...e };
  for (const o in t)
...
const De = class {
  ...
  applyOverrides(e) {
    (this._options = Ae(this._options, { overrides: e })),
  ...
  async _create() {
    ...
    (c.innerHTML = a), (this._iFrame = c.querySelector(`#${this._id}`));
